  ...
  return (
    <View className='flex-1'>
      <AppGradient colors={["#161b2e", "#0a4d4a", "#766e67"]}>
        <View className='mb-6'>
          <Text className='text-gray-200 mb-3 mt-9 font-bold text-4xl text-left'>Welcome Victor</Text>
          <Text className='text-indigo-100 text-xl font-medium'>Start Your Medittation Practice Today </Text>
        </View>
        <View>
